...
%\setcounter{tocdepth}{6}		% permet d'augmenter la numerotation
...
\newcommand{\definition}[2]{\noindent{\stepcounter{th}
    \parbox{\textwidth}{\textbf{\textcolor{OliveDrab}{Définition~\thechapter.\theth~:}}{~~\textit{#1}}~\setlength{\parindent}{15pt}\par#2\par~\par}}}
...
Comme nous pouvons le voir, les signaux OFDM résultent d’une modulation
multi-porteuses. C’est-à-dire que nous répartissons l’information sur une bande
de fréquence, autour de plusieurs porteuses de fréquences centrales également
réparties. Puis, à chaque sous-fréquences porteuses, on envoie des symboles
répartis dans le temps espacé par des intervalles de garde.
